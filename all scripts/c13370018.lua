...
function s.drcon(e,tp,eg,ep,ev,re,r,rp)
	-- Using the handler's controller instead of relying on tp parameter
	local p = e:GetHandlerPlayer()
	return Duel.IsExistingMatchingCard(Auxiliary.FaceupFilter(Card.IsCode,13370015),p,LOCATION_ONFIELD,0,1,nil)
end
