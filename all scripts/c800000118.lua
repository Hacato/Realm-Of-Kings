...
--Condition: control a Level 7 or higher Constructor monster
function s.cfilter(c)
	return c:IsFaceup() and c:IsSetCard(0x1568) and c:IsLevelAbove(7)
end
...
--Set from GY condition: Blisstopia is in a Field Zone
