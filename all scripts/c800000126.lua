...
function s.initial_effect(c)
	--Special Summon from hand if opponent controls monster(s)
	...
	c:RegisterEffect(e2)
	--Add 1 "SZS" monster, then discard 1
...
--E1: Special Summon condition (opponent controls monster)
...
--E3: Add "SZS" monster, then discard
function s.thfilter(c)
	return c:IsSetCard(0x2406) and c:IsMonster() and c:IsAbleToHand() and not c:IsCode(id)
end
