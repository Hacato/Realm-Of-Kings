...
function s.indcon(e)
	return Duel.IsExistingMatchingCard(Auxiliary.FaceupFilter(Card.IsSetCard,0x714),0,LOCATION_MZONE,0,1,nil)
end
...
function s.spfilter(c,e,tp,rc)
	return c:IsSetCard(0x714) and Card.ListsCode(c,rc) and c:IsCanBeSpecialSummoned(e,0,tp,true,false)
end
