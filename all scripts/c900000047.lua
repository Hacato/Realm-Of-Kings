...
function s.initial_effect(c)
	c:EnableReviveLimit()
	-- Cannot be Special Summoned except by Infernus Dominus
	...
	c:RegisterEffect(e1)
	-- On summon: negate all opponent face-up cards, banish your own field except this, burn 600 per banished
	...
	c:RegisterEffect(e2)
	-- Burn when it destroys monster by battle
...
-- Summon limit: only via Infernus Dominus (900000046)
function s.splimit(e,se,sp,st)
	return se and se:GetHandler():IsCode(900000046)
end
...
function s.smop(e,tp,eg,ep,ev,re,r,rp)
	...
	-- Banish all you control except this card
