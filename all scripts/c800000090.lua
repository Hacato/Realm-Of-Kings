...
function s.initial_effect(c)
	--Add 1 "YuYuYu" Pendulum Monster to Extra Deck face-up, then Special Summon 1 "YuYuYu" Link Monster
...
function s.spfilter(c,e,tp)
	return c:IsSetCard(0x991) and c:IsType(TYPE_LINK) and c:IsCanBeSpecialSummoned(e,0,tp,false,false)
end
