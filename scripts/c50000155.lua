...
function s.atkdn(e,tp,eg,ep,ev,re,r,rp,chk)
	...
	-- Check if both attacker and target exist before proceeding
	if not a then return end
	if a:IsControler(tp) and a:IsRace(RACE_WARRIOR) and d then
		Duel.Destroy(d,REASON_EFFECT)
	elseif d and d:IsControler(tp) and d:IsRace(RACE_WARRIOR) then
