...
function s.initial_effect(c)
	...
	--If Normal or Special Summoned: Special Summon 1 non-Dinosaur "Imaginary Arc" monster from hand
	...
	--If sent to GY as Fusion Material: change opponent's monster Type to Dinosaur
...
function s.spfilter(c,e,tp)
	return c:IsSetCard(SET_IMAGINARY_ARC) and c:IsMonster()
		and not c:IsRace(RACE_DINOSAUR)
