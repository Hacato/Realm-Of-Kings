...
local s,id=GetID()
if id==nil then id=800000249 end --Use the provided card ID
...
function s.spfilter(c,e,tp)
    return c:IsCode(800000249) and c:IsCanBeSpecialSummoned(e,0,tp,false,false)
end
...
function s.atlimit(e,c)
    return c:IsFaceup() and c:IsSetCard(0x8) and not c:IsCode(800000249) -- 0x8 is "HERO" archetype
end