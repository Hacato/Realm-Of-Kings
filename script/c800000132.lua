...
function s.initial_effect(c)
	...
	c:RegisterEffect(e2)
	--Reduce ATK/DEF after battle, then discard
	local e3=Effect.CreateEffect(c)
	e3:SetDescription(aux.Stringid(id,2))
	e3:SetCategory(CATEGORY_ATKCHANGE+CATEGORY_DEFCHANGE+CATEGORY_HANDES)
...
--E1: Special Summon condition (opponent controls more monsters)
...
--E3: Reduce ATK/DEF after battle
