...
local CARD_SKY_STRIKER_ACE_KAGARI=63288573

function s.initial_effect(c)
	--Fusion Summon
	c:EnableReviveLimit()
	Fusion.AddProcMix(c,true,true,CARD_SKY_STRIKER_ACE_KAGARI,s.matfilter)
	...
	--Opponent's monsters lose 1500 ATK
	...
	--Opponent's monsters lose 1500 DEF
	local e3=e2:Clone()
